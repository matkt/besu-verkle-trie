...
import static org.hyperledger.besu.ethereum.stateless.verkle.node.Node.getHighValue;
import static org.hyperledger.besu.ethereum.stateless.verkle.node.Node.getLowValue;

import org.hyperledger.besu.ethereum.stateless.verkle.hasher.TrieCommitmentHasher;
import org.hyperledger.besu.ethereum.stateless.verkle.node.BranchNode;
import org.hyperledger.besu.ethereum.stateless.verkle.node.InternalNode;
import org.hyperledger.besu.ethereum.stateless.verkle.node.LeafNode;
import org.hyperledger.besu.ethereum.stateless.verkle.node.Node;
import org.hyperledger.besu.ethereum.stateless.verkle.node.NullNode;
import org.hyperledger.besu.ethereum.stateless.verkle.node.StemNode;
import org.hyperledger.besu.ethereum.stateless.verkle.node.StoredNode;
