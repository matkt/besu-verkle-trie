...
import static org.hyperledger.besu.ethereum.stateless.bintrie.util.Parameters.CODE_OFFSET;
import static org.hyperledger.besu.ethereum.stateless.bintrie.util.Parameters.HEADER_STORAGE_OFFSET;
import static org.hyperledger.besu.ethereum.stateless.bintrie.util.Parameters.HEADER_STORAGE_SIZE;
import static org.hyperledger.besu.ethereum.stateless.bintrie.util.Parameters.MAIN_STORAGE_OFFSET_SHIFT_LEFT_VERKLE_NODE_WIDTH;
import static org.hyperledger.besu.ethereum.stateless.bintrie.util.Parameters.VERKLE_NODE_WIDTH;
import static org.hyperledger.besu.ethereum.stateless.bintrie.util.Parameters.VERKLE_NODE_WIDTH_LOG2;
...
/** Utility class providing static methods for key operations in the bintrie Trie structure. */
public class TrieKeyUtils {
  ...
  public static Bytes32 getStorageKeyTrieIndex(final Bytes32 storageKey) {
    ...
    if (uintStorageKey.compareTo(HEADER_STORAGE_SIZE) < 0) {
      ...
      // We divide by bintrieNodeWidthLog2 to make space and prevent any potential
      // overflow
