 ...
 *
 */
package org.hyperledger.besu.ethereum.stateless.bintrie.util;

import static org.hyperledger.besu.ethereum.stateless.bintrie.util.SuffixTreeDescriptor.BALANCE_BYTE_SIZE;
import static org.hyperledger.besu.ethereum.stateless.bintrie.util.SuffixTreeDescriptor.BALANCE_OFFSET;
import static org.hyperledger.besu.ethereum.stateless.bintrie.util.SuffixTreeDescriptor.CODE_SIZE_BYTE_SIZE;
import static org.hyperledger.besu.ethereum.stateless.bintrie.util.SuffixTreeDescriptor.CODE_SIZE_OFFSET;
import static org.hyperledger.besu.ethereum.stateless.bintrie.util.SuffixTreeDescriptor.NONCE_BYTE_SIZE;
import static org.hyperledger.besu.ethereum.stateless.bintrie.util.SuffixTreeDescriptor.NONCE_OFFSET;
import static org.hyperledger.besu.ethereum.stateless.bintrie.util.SuffixTreeDescriptor.VERSION_BYTE_SIZE;
import static org.hyperledger.besu.ethereum.stateless.bintrie.util.SuffixTreeDescriptor.VERSION_OFFSET;
