...
/**
 * Basic read and write operations for {@link StoredPartitionedBinaryTrie} through the factory and
 * mock storage layer.
 *
 * <p>Layer: trie ({@link PartitionedBinaryTrieFactory}, {@link NodeLoaderMock}). Root hashes and
 * deferred puts are compared against the in-memory {@link BinaryTrie} spec oracle.
 */
